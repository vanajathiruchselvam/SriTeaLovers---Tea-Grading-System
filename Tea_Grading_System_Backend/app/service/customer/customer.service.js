...
const log = log4js.getLogger('customer.service.js');
...
exports.create = (values) =>
  new Promise(async (resolve, reject) => {
    let responce = await BaseService.create(Customer, values, log);
    resolve(responce);
  });
...
exports.show = (model) =>
  new Promise(async (resolve, reject) => {
    ...
    let responce = await BaseService.show(Customer, model, log, attributes);
    resolve(responce);
  });
...
exports.update = (id, values) =>
  new Promise(async (resolve, reject) => {
    ...
    let responce = await BaseService.update(Customer, id, values, log);
    resolve(responce);
  });
...
exports.delete = (id) =>
  new Promise(async (resolve, reject) => {
    if (!id) reject(new Error(`id can't be empty`));
    let responce = await BaseService.delete(Customer, id, log);
    resolve(responce);
  });
...
exports.search = (query, except, status) =>
  new Promise(async (resolve, reject) => {
    ...
    let values = await BaseService.search(Customer, log, condition, attributes);
    resolve(values);
  });
/**
 *
 ...
 * @param {*} value
 */
 exports.count = (field, value) =>
 new Promise(async (resolve, reject) => {
   let values = await BaseService.count(Customer, field, value, log);
   resolve(values);
 });
...
*/
exports.find = (field, value) =>
 new Promise(async (resolve, reject) => {
   let values = await BaseService.find(Customer, field, value, log);
   resolve(values);
 });
